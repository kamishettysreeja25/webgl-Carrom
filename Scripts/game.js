...
{
	if(Key.isDown(Key.F) /*&& velocity < 5*/)
		velocity += 0.1;
	else if(Key.isDown(Key.S) /*&& velocity > 0*/)
		velocity -= 0.1;
	else if (Key.isDown(Key.P))
		view_player();
	else if(Key.isDown(Key.T))
		view_top();
	else if(Key.isDown(Key.A) /*&& arrowHelper.rotation.z > -3.14*/)
	{
		temp -= 0.01;
...
//		arrowHelper.rotation.z -= 0.01;
	...
	else if(Key.isDown(Key.D) /*&& arrowHelper.rotation.z < 3.14*/)
	{
		temp += 0.01;
//		arrowHelper.rotation.z += 0.01;
		scene.remove(arrowHelper);
